...
$customFields = array(
				...
				array(
  				...
  				array(
					...
					array(
						...
						"title"       => __("Poster Image URL",'rt_theme_admin'), 
						"description" => __("Poster image for the video. If this field is empty the featured image will be used as a poster image",'rt_theme_admin'),
						"type"        => "upload", 
					),
				...
				array(
					"title"       => __("Masonry View",'rt_theme_admin'), 
					"description" => __('Set the column width of the element when displaying in a masonry layout','rt_theme_admin'),
					"name"        => "_masonry_view",
					"options"     =>  array(
											"same"   => __("Same Width",'rt_theme_admin'), 
											"double" => __("Double Width",'rt_theme_admin'), 
									),
					"type"        => "select", 
				),
