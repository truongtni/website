...
class Latest_Posts extends WP_Widget {
	...
	function __construct() {
		$opts =array(
					...
					'description' 	=> __( 'The most recent posts on your site with post thumbnails and date boxes.', 'rt_theme_admin' )
				);

		parent::__construct('latest_posts_2', '['. RT_THEMENAME.']   '.__('Recent Posts ', 'rt_theme_admin'), $opts);
	}
