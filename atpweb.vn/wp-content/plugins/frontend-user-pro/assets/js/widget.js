...
*
* http://miled.github.io/frontend-social-login/ | https://github.com/miled/frontend-social-login
*  (c) 2011-2014 Mohamed Mrassi and contributors | http://wordpress.org/plugins/frontend-social-login/
*/
...
(function($){ 
	$(function(){ 
		$(document).on( 'click', 'a.wpfeup-social-login-provider', function(){
...
*/
window.wsl_frontend_social_login = function( config ){
