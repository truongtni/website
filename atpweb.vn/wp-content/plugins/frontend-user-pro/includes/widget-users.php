...
class Feup_Members_Widget_Users extends WP_Widget {
	...
	function Feup_Members_Widget_Users() {
		...
		$widget_options = array(
			'classname' => 'users',
			'description' => esc_html__( 'Provides the ability to list the users of the site.', 'feup_members' )
		);
		...
		$control_options = array(
			'width' => 525,
			'height' => 350,
			'id_base' => 'feup_members-widget-users'
		);

		/* Create the widget. */
		$this->WP_Widget( 'feup_members-widget-users', esc_attr__( 'Users', 'feup_members' ), $widget_options, $control_options );
	}
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_attr__( 'Users', 'feup_members' ),
			'order' => 'ASC',
			'orderby' => 'login',
			'role' => '',
			'meta_key' => '',
		...
		$order = array( 'ASC' => esc_attr__( 'Ascending', 'feup_members' ), 'DESC' => esc_attr__( 'Descending', 'feup_members' ) );
		$orderby = array( 'display_name' => esc_attr__( 'Display Name', 'feup_members' ), 'email' => esc_attr__( 'Email', 'feup_members' ), 'ID' => esc_attr__( 'ID', 'feup_members' ), 'nicename' => esc_attr__( 'Nice Name', 'feup_members' ), 'post_count' => esc_attr__( 'Post Count', 'feup_members' ), 'registered' => esc_attr__( 'Registered', 'feup_members' ), 'url' => esc_attr__( 'URL', 'feup_members' ), 'user_login' => esc_attr__( 'Login', 'feup_members' ) );
		$meta_key = array_merge( array( '' ), (array) feup_members_get_user_meta_keys() );
		$roles = array( '' => '' );
