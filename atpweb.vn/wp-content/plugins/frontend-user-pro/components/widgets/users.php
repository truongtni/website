...
class Feup_Members_Widget_Users extends WP_Widget {

	function Feup_Members_Widget_Users() {
		$widget_ops = array( 'classname' => 'users', 'description' => __('An advanced widget that gives you total control over the output of your user lists.','feup_members') );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'feup_members-widget-users' );
		$this->WP_Widget( 'feup_members-widget-users', __('Users', 'feup_members'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		//Defaults
		$defaults = array( 'title' => __('Users', 'feup_members'), 'show_fullname' => true, 'order' => 'ASC', 'orderby' => 'display_name' );
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>

		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'feup_members'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e('Limit:', 'feup_members'); ?> <code>limit</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'include' ); ?>"><?php _e('Include:', 'feup_members'); ?> <code>include</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'exclude' ); ?>"><?php _e('Exclude:', 'feup_members'); ?> <code>exclude</code></label>
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['show_fullname'], true ); ?> id="<?php echo $this->get_field_id( 'show_fullname' ); ?>" name="<?php echo $this->get_field_name( 'show_fullname' ); ?>" /> <?php _e('Show full name?', 'feup_members'); ?> <code>show_fullname</code></label>
		</p>
