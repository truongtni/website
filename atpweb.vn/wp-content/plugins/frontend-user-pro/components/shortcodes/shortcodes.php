...
/* Add shortcodes. */
add_action( 'init', 'feup_members_component_shortcodes_register_shortcodes' );
 ...
 * @since 0.2.0
 */
function feup_members_component_shortcodes_register_shortcodes() {
	add_shortcode( 'login-form', 'feup_members_login_form_shortcode' );
	add_shortcode( 'access', 'feup_members_access_check_shortcode' );
	add_shortcode( 'feed', 'feup_members_access_check_shortcode' );
	add_shortcode( 'is_user_logged_in', 'feup_members_is_user_logged_in_shortcode' );
	add_shortcode( 'get_avatar', 'feup_members_get_avatar_shortcode' );
	add_shortcode( 'avatar', 'feup_members_get_avatar_shortcode' );
}
 ...
 */
function feup_members_get_avatar_shortcode( $attr ) {
 ...
 */
function feup_members_is_user_logged_in_shortcode( $attr, $content = null ) {
 ...
 * @return $content string The content to be shown.
 */
function feup_members_feed_shortcode( $attr, $content = null ) {
 ...
 */
function feup_members_access_check_shortcode( $attr, $content = null ) {
 ...
 */
function feup_members_login_form_shortcode() {
