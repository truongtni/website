...
<div class="wrap">
	...
	<?php if ( !empty( $role_updated ) ) echo '<div class="updated"><p><strong>' . __( 'Role updated.', 'feup_members' ) . '</strong></p><p><a href="' . admin_url( 'users.php?page=roles' ) . '">' . __( '&larr; Back to Roles', 'feup_members' ) . '</a></p></div>'; ?>
	...
	<div id="poststuff">
		...
		<form name="form0" method="post" action="<?php echo admin_url( esc_url( "users.php?page=roles&amp;action=edit&amp;role={$role->name}" ) ); ?>">
			...
			<table class="form-table">
				...
				<tr>
					<th>
						<?php _e( 'Capabilities', 'feup_members' ); ?>
					</th>
				...
				<tr>
					<th>
						<?php _e( 'Custom Capabilities', 'feup_members' ); ?>
					</th>
					<td>

						<p class="feup_members-add-new-cap-wrap clear hide-if-no-js">
							<a class="button-secondary" id="feup_members-add-new-cap"><?php _e( 'Add New Capability', 'feup_members' ); ?></a>
						</p>
			...
			<?php submit_button( esc_attr__( 'Update Role', 'feup_members' ) ); ?>
