...
// Don't duplicate me!
if( !class_exists( 'ReduxFrameworkNew_extension_customizer' ) ) {


    /**
     * Main ReduxFrameworkNew customizer extension class
     *
     * @since       1.0.0
     */
    class ReduxFrameworkNew_extension_customizer extends ReduxFrameworkNew {
            ...
            foreach( $section['fields'] as $skey => $option ) {
              ...
              if( !empty( $option['data'] ) && empty( $option['options'] ) ) {
                ...
                if ($option['data'] == "elusive-icons" || $option['data'] == "elusive-icon" || $option['data'] == "elusive" ) {
                      $icons_file = ReduxFrameworkNew::$_dir.'inc/fields/select/elusive-icons.php';
