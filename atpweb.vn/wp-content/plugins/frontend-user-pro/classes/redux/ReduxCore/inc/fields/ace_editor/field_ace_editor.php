...
// Don't duplicate me!
if( class_exists( 'ReduxFrameworkNew_ace_editor' ) ) return;

class ReduxFrameworkNew_ace_editor { 
    ...
    /**
        ...
        public function enqueue() {
            ...
            wp_enqueue_style(
                ...
                ReduxFrameworkNew::$_url . 'inc/fields/ace_editor/field_ace_editor.css',
                time(),
                true
            );
            wp_enqueue_script(
                'redux-field-ace-editor-js', 
                ReduxFrameworkNew::$_url . 'inc/fields/ace_editor/field_ace_editor.js', 
