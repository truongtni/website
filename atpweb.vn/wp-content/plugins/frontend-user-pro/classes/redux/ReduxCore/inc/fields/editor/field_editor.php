...
// Don't duplicate me!
if( !class_exists( 'ReduxFrameworkNew_editor' ) ) {

    /**
     * Main ReduxFrameworkNew_editor class
     *
     * @since       1.0.0
     */
    class ReduxFrameworkNew_editor {
        ...
        public function enqueue() {
            ...
            wp_enqueue_style(
                ...
                ReduxFrameworkNew::$_url . 'inc/fields/editor/field_editor.css',
                time(),
                true
            );
