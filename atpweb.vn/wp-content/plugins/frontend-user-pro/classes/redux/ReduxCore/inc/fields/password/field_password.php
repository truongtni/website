<?php
/**
 * Class ReduxFrameworkNew_password
 */
class ReduxFrameworkNew_password {
	...
	private function _render_combined_field() {
		...
		$defaults    = array(
			...
			'password'    => '',
			'placeholder' => array(
				'password' => __( 'Password', 'redux-framework-new' ),
				'username' => __( 'Username', 'redux-framework-new' )
			)
		);
