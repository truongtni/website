...
// Don't duplicate me!
if( !class_exists( 'ReduxFrameworkNew_background' ) ) {

    /**
     * Main ReduxFrameworkNew_background class
     *
     * @since       3.1.5
     */
    class ReduxFrameworkNew_background {
        ...
        public function render() {
            ...
            if ($this->field['background-color'] === true) {
                ...
                if ( !isset( $this->field['transparent'] ) || $this->field['transparent'] !== false ) {
                    ...
                    echo '<label for="' . $this->field['id'] . '-transparency" class="color-transparency-check"><input type="checkbox" class="checkbox color-transparency redux-background-input ' . $this->field['class'] . '" id="' . $this->field['id'] . '-transparency" data-id="'.$this->field['id'] . '-color" value="1"'.$tChecked.'> '.__('Transparent', 'redux-framework-new').'</label>';       
                }
            ...
            if ( $this->field['background-repeat'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-repeat-select" data-placeholder="' . __( 'Background Repeat', 'redux-framework-new' ) . '" name="' . $this->field['name'] . '[background-repeat]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-repeat '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ( $this->field['background-clip'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-repeat-select" data-placeholder="' . __( 'Background Clip', 'redux-framework-new' ) . '" name="' . $this->field['name'] . '[background-clip]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-clip '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ( $this->field['background-origin'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-repeat-select" data-placeholder="' . __( 'Background Origin', 'redux-framework-new' ) . '" name="' . $this->field['name'] . '[background-origin]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-origin '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ( $this->field['background-size'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-repeat-select" data-placeholder="' . __( 'Background Size', 'redux-framework-new' ) . '" name="' . $this->field['name'] . '[background-size]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-size '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ( $this->field['background-attachment'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-attachment-select" data-placeholder="' . __( 'Background Attachment', 'redux-framework-new' ) . '" name="' . $this->field['name'] . '[background-attachment]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-attachment '.$this->field['class'].'">';
                    echo '<option></option>';
                    foreach ($array as $k=>$v) {
            ...
            if ( $this->field['background-position'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-position-select" data-placeholder="' . __( 'Background Position', 'redux-framework-new' ) . '" name="' . $this->field['name'] . '[background-position]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-position '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ($this->field['background-image'] === true) {
                ...
                $placeholder = isset($this->field['placeholder']) ? $this->field['placeholder'] : __('No media selected','redux-framework-new');
                ...
                echo '<span class="button background_upload_button" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'redux-framework-new' ) . '</span>';
                
                $hide = '';
                if( empty( $this->value['background-image'] ) || $this->value['background-image'] == '' )
                    $hide =' hide';

                echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'redux-framework-new' ) . '</span>';
        ...
        public function enqueue() {
            wp_enqueue_script(
                ...
                ReduxFrameworkNew::$_url . 'inc/fields/background/field_background.js',
            ...
            wp_enqueue_script(
                'field-select-js', 
                ReduxFrameworkNew::$_url.'inc/fields/select/field_select.js',
            ...
            wp_enqueue_style(
                ...
                ReduxFrameworkNew::$_url . 'inc/fields/background/field_background.css',
                time(),
                true
            );
            ...
            wp_enqueue_style(
                ...
                ReduxFrameworkNew::$_url.'inc/fields/select/field_select.css', 
                time(),
                true
            );  
