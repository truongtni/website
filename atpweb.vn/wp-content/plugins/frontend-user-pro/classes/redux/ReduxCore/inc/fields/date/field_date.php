...
// Don't duplicate me!
if( !class_exists( 'ReduxFrameworkNew_date' ) ) {

    /**
     * Main ReduxFrameworkNew_date class
     *
     * @since       1.0.0
     */
	class ReduxFrameworkNew_date {
		...
		public function enqueue() {
			wp_enqueue_script(
				'redux-field-date-js', 
				ReduxFrameworkNew::$_url . 'inc/fields/date/field_date.js',
