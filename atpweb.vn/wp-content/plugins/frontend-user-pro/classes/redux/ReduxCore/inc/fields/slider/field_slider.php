<?php
class ReduxFrameworkNew_slider {	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			...
			ReduxFrameworkNew::$_url.'inc/fields/slider/field_slider.js', 
		...
		wp_enqueue_style(
			...
			ReduxFrameworkNew::$_url.'inc/fields/slider/field_slider.css', 
			time(),
			true
		);		
