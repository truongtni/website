...
<div class="highlight"><pre><span class="cp">&lt;?php</span>
    <span class="nv">$fields</span> <span class="o">=</span> <span class="k">array</span><span class="p">(</span>
        ...
        <span class="s1">'title'</span> <span class="o">=&gt;</span> <span class="nx">__</span><span class="p">(</span><span class="s1">'Textarea Option - HTML Validated Custom'</span><span class="p">,</span> <span class="s1">'redux-framework-new-demo'</span><span class="p">),</span> 
        <span class="s1">'subtitle'</span> <span class="o">=&gt;</span> <span class="nx">__</span><span class="p">(</span><span class="s1">'Custom HTML Allowed (wp_kses)'</span><span class="p">,</span> <span class="s1">'redux-framework-new-demo'</span><span class="p">),</span>
        <span class="s1">'desc'</span> <span class="o">=&gt;</span> <span class="nx">__</span><span class="p">(</span><span class="s1">'This is the description field, again good for additional info.'</span><span class="p">,</span> <span class="s1">'redux-framework-new-demo'</span><span class="p">),</span>
...
<pre>
    $fields = array(
        'id'=>'7',
        'type' => 'textarea',
        'title' => __('Textarea Option - HTML Validated Custom', 'redux-framework-new-demo'), 
        'subtitle' => __('Custom HTML Allowed (wp_kses)', 'redux-framework-new-demo'),
        'desc' => __('This is the description field, again good for additional info.', 'redux-framework-new-demo'),
...
class ReduxFrameworkNew_textarea {
     ...
     * Example Documentation:
            $fields = array(
                'id'       => 'css_editor',
                'type'     => 'ace_editor',
                'title'    => __('CSS Code', 'redux-framework-new-demo'), 
                'subtitle' => __('Paste your CSS code here.', 'redux-framework-new-demo'),
                'mode'     => 'css',
                'theme'    => 'monokai',
     ...
     * @param $parent ReduxFrameworkNew object is passed for easier pointing.
