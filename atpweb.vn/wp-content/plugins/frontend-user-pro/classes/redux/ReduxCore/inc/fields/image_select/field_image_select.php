...
// Don't duplicate me!
if( !class_exists( 'ReduxFrameworkNew_image_select' ) ) {

    /**
     * Main ReduxFrameworkNew_image_select class
     *
     * @since       1.0.0
     */
    class ReduxFrameworkNew_image_select {
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                ...
                ReduxFrameworkNew::$_url . 'inc/fields/image_select/field_image_select.js', 
                array( 'jquery' ),
                time(),
                true
            );
            ...
            wp_enqueue_style(
                ...
                ReduxFrameworkNew::$_url . 'inc/fields/image_select/field_image_select.css',
                time(),
                true
            );
