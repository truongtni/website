...
// Don't duplicate me!
if( !class_exists( 'ReduxFrameworkNew_button_set' ) ) {

    /**
     * Main ReduxFrameworkNew_button_set class
     *
     * @since       1.0.0
     */
    class ReduxFrameworkNew_button_set {
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                ...
                ReduxFrameworkNew::$_url.'inc/fields/button_set/field_button_set.js', 
                array(),
                time(),
                true
            );            
