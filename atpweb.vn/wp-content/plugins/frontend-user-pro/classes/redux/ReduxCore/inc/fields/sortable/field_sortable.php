<?php
class ReduxFrameworkNew_sortable {
    ...
    */
    ...
    function enqueue() {
        ...
        wp_enqueue_style(
            ...
            ReduxFrameworkNew::$_url.'inc/fields/sortable/field_sortable.css', 
            time(),
            true
        );  
        ...
        wp_enqueue_script(
            ...
            ReduxFrameworkNew::$_url . 'inc/fields/sortable/field_sortable.js', 
            array('jquery'),
            time(),
            true
        );        
