 ...
 * @package Wordpress
 * @subpackage ReduxFrameworkNew
 * @since 3.1.2
 */

class ReduxFrameworkNew_select_image {
...
//function
    ...
    function enqueue() {
        wp_enqueue_script(
            ...
            ReduxFrameworkNew::$_url . 'inc/fields/select_image/field_select_image.js', 
            array(), 
            time(), 
            true
        );
        ...
        wp_enqueue_style(
            ...
            ReduxFrameworkNew::$_url . 'inc/fields/select_image/field_select_image.css', 
            time(), 
            true
        );
    }
