...
class ReduxFrameworkNew_dimensions {
...
//function
    ...
    function render() {
        ...
        if ($this->field['width'] === true):
            ...
            echo '<input type="text" class="redux-dimensions-input redux-dimensions-width mini' . $this->field['class'] . '" placeholder="' . __('Width', 'redux-framework-new') . '" rel="' . $this->field['id'] . '-width" value="' . filter_var($this->value['width'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
        ...
        if ($this->field['height'] === true):
            ...
            echo '<input type="text" class="redux-dimensions-input redux-dimensions-height mini' . $this->field['class'] . '" placeholder="' . __('height', 'redux-framework-new') . '" rel="' . $this->field['id'] . '-height" value="' . filter_var($this->value['height'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
        ...
        **/
        ...
        if (isset($this->field['units']) && $this->field['units'] !== false){
            echo '<div class="select_wrapper dimensions-units" original-title="' . __('Units', 'redux-framework-new') . '">';
            echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . __('Units', 'redux-framework-new') . '" class="redux-dimensions redux-dimensions-units select' . $this->field['class'] . '" original-title="' . __('Units', 'redux-framework-new') . '" name="' . $this->field['name'] . '[units]' . $this->field['name_suffix'] . '">';
...
//function
    ...
    function enqueue() {
        ...
        wp_enqueue_script(
            ...
            ReduxFrameworkNew::$_url . 'inc/fields/dimensions/field_dimensions.js', 
            array('jquery'), 
            time(), 
            true
        );
        ...
        wp_enqueue_style(
            ...
            ReduxFrameworkNew::$_url . 'inc/fields/dimensions/field_dimensions.css', 
            time(), 
            true
        );
    }
