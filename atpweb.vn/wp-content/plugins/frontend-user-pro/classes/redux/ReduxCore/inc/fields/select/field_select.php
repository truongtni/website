<?php
class ReduxFrameworkNew_select {	
	...
	*/
	function render(){
		...
		if (!empty($this->field['options'])) {
			...
			$placeholder = (isset($this->field['placeholder'])) ? esc_attr($this->field['placeholder']) : __( 'Select an item', 'redux-framework-new' );
			...
			echo '<strong>'.__('No items of this type were found.', 'redux-framework-new').'</strong>';
		}
