...
// Don't duplicate me!
if (!class_exists('ReduxFrameworkNew_section')) {

    /**
     * Main ReduxFrameworkNew_heading class
     *
     * @since       1.0.0
     */
    class ReduxFrameworkNew_section {
...
<?php             
        ...
        public function enqueue() {
            wp_enqueue_style(
                    'redux-field-section-css', ReduxFrameworkNew::$_url . 'inc/fields/section/field_section.css', time(), true
            );
        }
