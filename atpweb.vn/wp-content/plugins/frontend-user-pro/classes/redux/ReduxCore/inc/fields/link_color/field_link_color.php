...
// Don't duplicate me!
if( !class_exists( 'ReduxFrameworkNew_link_color' ) ) {

    /**
     * Main ReduxFrameworkNew_link_color class
     *
     * @since       1.0.0
     */
    class ReduxFrameworkNew_link_color {
        ...
        public function render() {
            ...
            if ( $this->field['regular'] === true && $this->field['default']['regular'] !== false ):
                echo '<strong>' . __( 'Regular', 'redux-framework-new' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-regular" name="' . $this->field['name'] . '[regular]' . $this->field['name_suffix'] . '" value="'.$this->value['regular'].'" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['regular'] . '" />&nbsp;&nbsp;&nbsp;&nbsp;';
            endif;

            if ( $this->field['hover'] === true && $this->field['default']['hover'] !== false ):
                echo '<strong>' . __( 'Hover', 'redux-framework-new' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-hover" name="' . $this->field['name'] . '[hover]' . $this->field['name_suffix'] . '" value="' . $this->value['hover'] . '" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['hover'] . '" />&nbsp;&nbsp;&nbsp;&nbsp;';
            endif;

            if ( $this->field['visited'] === true && $this->field['default']['visited'] !== false ):
                echo '<strong>' . __( 'Visited', 'redux-framework-new' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-hover" name="' . $this->field['name'] . '[visited]' . $this->field['name_suffix'] . '" value="' . $this->value['visited'] . '" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['visited'] . '" />&nbsp;&nbsp;&nbsp;&nbsp;';
            endif;            

            if ( $this->field['active'] === true && $this->field['default']['active'] !== false ):
                echo '<strong>' . __( 'Active', 'redux-framework-new' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-active" name="' . $this->field['name'] . '[active]' . $this->field['name_suffix'] . '" value="' . $this->value['active'] . '" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['active'] . '" />';
            endif;
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                ...
                ReduxFrameworkNew::$_url . 'inc/fields/color/field_color.js', 
            ...
            wp_enqueue_style(
                'redux-field-color-js', 
                ReduxFrameworkNew::$_url . 'inc/fields/color/field_color.css', 
                time(),
                true
            ); 
