...
// Don't duplicate me!
if( !class_exists( 'ReduxFrameworkNew_media' ) ) {

    /**
     * Main ReduxFrameworkNew_media class
     *
     * @since       1.0.0
     */
    class ReduxFrameworkNew_media {
        ...
        public function render() {
            ...
            echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'redux-framework-new' ) . '</span>';
