...
class ReduxFrameworkNew_spinner {
    ...
    function enqueue() {
		...
		wp_enqueue_script(
			...
			ReduxFrameworkNew::$_url.'inc/fields/spinner/field_spinner.js', 
			array('jquery', 'redux-user', 'jquery-ui-core', 'jquery-ui-dialog'),
			time(),
			true
		);
		...
		wp_enqueue_style(
			...
			ReduxFrameworkNew::$_url.'inc/fields/spinner/field_spinner.css', 
			time(),
			true
		);	    	
