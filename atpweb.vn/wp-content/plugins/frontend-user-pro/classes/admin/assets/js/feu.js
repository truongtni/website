jQuery(document).ready(function($){
    ...
    /*
        ...
        and parse.
            ...
            JSON.stringify(value, replacer, space)
                ...
                used to select the feup_members to be serialized. It filters the results
                such that only feup_members with keys listed in the replacer array are
                stringified.
    ...
    */
    ...
    // If the replacer is an array, use it to select the feup_members to be stringified.
    ...
    jQuery(".front-end-upload").each(function(){
        ...
        var usersettings = {
            ...
            init : {
                FileUploaded: function(up, file, info) {
                    ...
                    var user_latestID = info.response;
                    jQuery('.front-end-upload-flags').append('<input type="hidden" name="user_file_ids[]" value="' + user_latestID + '" />');
                },
        ...
        if(FEU_VARS.customext){
            usersettings.filters.push(FEU_VARS.customext);
        }

        // init plupload
        jQuery(this).pluploadQueue(usersettings);
    ...
    jQuery('.front-end-upload-parent form').submit(function(e) {
        ...
        if( jQuery("#user_email").length ){
            if( !re.test(jQuery("#user_email").val()) ){
        ...
        var userref = jQuery(this);
        var uploader = userref.parents('.front-end-upload-parent').find('.front-end-upload').pluploadQueue();
