...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<?php else:?>
		<div class="buttons">
			<div class="button_wrapper aligncenter"><a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button_ medium default"><span class="icon-shopping-bag"></span><?php _e( 'View Cart', 'woocommerce' ); ?></a></div>
			<div class="button_wrapper aligncenter"><a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button_ medium color checkout"><span class="icon-credit-card"></span><?php _e( 'Checkout', 'woocommerce' ); ?></a></div>
		</div>
	<?php endif;?>	
