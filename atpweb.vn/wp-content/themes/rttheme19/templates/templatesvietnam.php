<?php
/*
* Template Name: templatesvietnam
*/
?>
<?php get_header(); ?>
...
<p class="button"><a href="<?=LINKWEB?>/w/?theme=<?=get_the_id()?>">Demo</a><a href="<?php the_permalink() ;?>">Tạo web</a></p>
...
<center><div style="display: inline-block;">
  ...
  <a style="color: black;
    ...
    transition: background-color .3s;
    border: 1px solid #ddd;
    margin: 0 4px;" href="<?=LINKWEB?>/templates8">8</a>
  <a style="color: black;
    float: left;
    padding: 8px 16px;
    text-decoration: none;
